function HideAndShow(e, t) {
	...
	function() {
		...
		e && ((e = $(e)).show(), e.css("opacity", "0"), e.animate({
			opacity: 1
		},
		"slow", t))
	})
...
function() {
	...
	$(function() {
		...
		function() {
			...
			500 < Date.now() - this.last_click ? this.last_click = Date.now() : q.show("map")
		}),
		$(".sender-btn").on("click", x),
		$(".room_exits").on("mousedown", T.before_click_exits).on("mouseup", T.click_exits),
		$(".room-title>.map-icon").on("click",
		function() {
			A.LoadMap()
		}),
	...
	var n, t, o = {
		ResetPwd: function() {
			...
			return n ? n.length < 6 || 20 < n.length ? w("#update_pwd2", "密码长度在6到20之间") : n != i ? w("#reset_pwd2", "两次密码输入不一致") : (k("正在修改密码", "#reset_panel"), void G.UserAPI.ResetPassword(e, t, s, i,
			function(e) {
		...
		UpdatePwd: function() {
			var e = $("#update_pwd1").val(),
			t = $("#update_pwd2").val(),
			s = $("#update_pwd3").val();
			return e.length < 6 || 20 < e.length ? w("#update_pwd1", "密码长度在6到20之间") : t.length < 6 || 20 < t.length ? w("#update_pwd2", "密码长度在6到20之间") : s != t ? w("#update_pwd3", "两次密码输入不一致") : (k("正在修改密码", "#pwd_panel"), void G.UserAPI.ChangePassword(e, t,
			function(e) {
		...
		LoginIn: function() {
			...
			t = $("#login_pwd").val();
			return e ? /^[a-z0-9]{5,15}$/.test(e) ? t ? t.length < 6 || 20 < t.length ? w("#login_pwd", "密码长度在6到20之间") : (k("正在登录", "#login_panel"), void G.UserAPI.Login(e, t,
			function(e) {
		...
		SelectServer: function() {
			if (n) {
				...
				if (! (0 <= e && e < n.length)) return U.Show({
		...
		CreateRole: function() {
			...
			/^[\u4E00-\u9FA5]{2,5}$/.test(e.name) ? e.str < 15 || 30 < e.str ? w("#reg_name", "臂力需要在15-30之间") : e.con < 15 || 30 < e.con ? w("#reg_name", "根骨需要在15-30之间") : e.dex < 15 || 30 < e.dex ? w("#reg_name", "身法需要在15-30之间") : e.int < 15 || 30 < e.int ? w("#reg_name", "悟性需要在15-30之间") : e.str + e.con + e.dex + e.int != 80 ? w("#reg_name", "先天属性需要在15-30之间，并且总和等于80") : (k("正在创建角色", "#addrole_panel"), void c("createrole " + e.name + " " + e.gender + " " + e.str + " " + e.con + " " + e.dex + " " + e.int)) : w("#reg_name", "名称格式错误，只能使用2-5位中文字符")
		},
		AddRole: function() {
			if (4 < $(".role-list>.role-item").length) return U.Show({
				content: "你只能最多创建五个角色"
			});
	...
	function l() {
		if (!n) return k("正在获取服务器列表"),
		void G.UserAPI.GetServer(function(e) {
			...
			function() {
				...
				try {
					...
					$(".server-list").html(e.join("")).on("click", "li",
					function() {
						var e = $(this);
		...
		if (e && e.length) {
			var t = h("s"),
			s = t ? n[t] : 1 == e.length ? n[0] : null;
			if (s) return k("正在连接服务器"),
			g(s);
			HideAndShow("#slist_panel")
		} else HideAndShow("#login_panel"),
		w("#login_pwd", "获取服务器列表出错")
	}
	function h(e) {
	...
	function r(e) {
		...
		return p && (t.closest(".chat-panel").length || ($(".chat-panel").addClass("hide"), p = !1)),
		U.Close(),
		!1
	}
	function c(e) {
	...
	function m() {
		...
		if ("emote" != s) {
			if (!t.is(".selected")) {
				var i = t.parent();
				return i.children().removeClass("selected"),
				t.addClass("selected"),
				i.attr("channel", s),
				$(".sender-box").focus(),
				!1
			}
		} else(e = $(".channel-emotes")).is(".hide") ? (e.removeClass("hide"), T.emtoes || (c("emote"), T.emtoes = [], $(".sender-box").blur(), e.on("click", "span",
		function() {
			var e = $(this).html();
	...
	function d(e) {
		...
		case "showchat":
			return function() {
				...
				e.is(".hide") ? p = !1 : (p = !0, e.find("input").val("").focus());
				return ! 1
			} ();
		case "showcombat":
			return E.Show();
	...
	var u, f, v = {
		...
		ShowTools: function() {
			if (this.InitTools(), 1 != this.ToolState) {
				if (0 == this.ToolState) {
					for (var e = 0; e < this.Tools.length; e++) this.Tools[e].style.display = "",
					this.Tools[e].style.opacity = 0;
					this.ToolSpeed = 200,
					this.ToolOpacity = 0,
					$(this.HideTool).removeClass("hide-tool")
				} else this.ToolOpacity = 100,
				this.ToolSpeed = 100,
		...
		ShowToolsAnimate: function(e) {
			if (0 == e) {
				...
				for (var t = this.ToolOpacity,
				s = this.Tools.length - 1; 0 <= s && (this.Tools[s].style.opacity = t < 0 ? 0 : 100 < t ? 1 : t / 100, !((t -= 20) < 0)); s--);
				this.ToolOpacity -= 30,
				...
				if (this.ToolOpacity -= 20, 0 <= t) window.setTimeout(this.ShowToolsAnimate.bind(this, e), 100);
				else for (s = this.ToolState = 0; s < this.Tools.length; s++) this.Tools[s].style.display = "none"
			}
		},
	...
	function g(e, t) {
		_ || (s = e, console.log("重新连接", null == i ? "未连接": "已连接"), i = new L(e.IP, e.Port), _ = !0, i.OnError = function(e, t) {
			_ = !1,
			e && (e.isTrusted && (e = "服务器没有响应，请稍后重试"), k("<strong>连接失败：</strong>" + e))
		},
		i.OnConnect = function() {
			_ = !1,
			t || T.player ? c(t ? h("u") + " " + h("p") + " " + t + " " + e.ID: h("u") + " " + h("p") + " " + T.player) : (k("正在获取角色列表..."), c(h("u") + " " + h("p")))
		},
		i.OnClose = function(e) {
			_ = !1,
			console.log(this.Port, this.ChangeServer),
			this.ChangeServer ? this.ChangeServer = !1 : this.Connected() || (T.player ? (T.clear(), S("<red>你的连接中断了...</red>")) : HideAndShow($("#slist_panel")))
		},
		i.OnData = y, i.OnMessage = S, i.Connect())
	}
	function w(e, t) {
	...
	var b = 0;
	function S(e) {
		f || (f = $("<pre></pre>").appendTo(u)),
		1e3 < b && (b = 0, f.empty()),
		f.append(e + "\n"),
		b++,
		T.contentScroll && (u[0].scrollTop = 99999)
	}
	function y(e) {
		var t = T[e.type];
		t && t(e)
	...
	function C(e) {
		...
		case "id":
			$("#reg_id").val(function() {
				for (var e = "abcdefghijklmnopqrstuvwxyz",
				t = "123456789",
				s = [], i = parseInt(3 * Math.random()) + 3, n = 0; n < i; n++) n < 3 ? s.push(e[parseInt(Math.random() * e.length)]) : s.push(t[parseInt(Math.random() * t.length)]);
				return s.join("")
			} ());
			break;
		case "prop":
	...
	var T = {
		...
		init: function() {
			T.itemsElement = $(".room_items"),
			(u = $(".content-message")).on("mousedown",
			function() {
				T.contentScroll = !1
			}),
			u.on("mouseup",
		...
		onContentScroll: function(e) {
			...
			4e3), T.contentScroll = !1) : u[0].scrollTop + u.height() >= u[0].scrollHeight && (T.contentScroll = !0)
		},
		regist: function(e) {
		...
		emote: function(e) {
			T.emotes = e.items || 0;
			for (var t = [], s = 0; s < T.emotes.length; s++) t.push("<span>"),
			t.push(T.emotes[s]),
			t.push("</span>");
		...
		cross: function(e) {
			for (var t = null,
			s = 0; s < n.length; s++) n[s].ID == e.sid && (t = n[s]);
			t && (i.ChangeServer = !0, i.Close(), q.pack.items = null, console.log("重新连接到", t.Name), e.pid || T.die({
				relive: !0
			}), g(t, e.pid))
		},
		roles: function(e) {
			...
			if (t.length) {
				HideAndShow("#role_panel");
				for (var s = [], i = 0; i < t.length; i++) s.push("<li class='role-item"),
				0 == i && s.push(" select"),
		...
		loginerror: function(e) {
			$(".container").hide(),
			$(".login-content").show(),
			k("<strong>登陆失败：</strong>" + e.msg)
		},
		login: function(e) {
			T.player || HideAndShow(".container"),
			T.player = e.id,
			R.load(e.setting),
			t && (c(t), t = null)
		},
		...
		itemremove: function(e) {
			...
			if (t) {
				...
				i.remove(),
				delete E.STATUS[e.id]
			}
		},
		itemadd: function(e) {
			if (!R.off_plist || !e.p || e.id == T.player) {
				var t, s = e;
				t = R.item_firstme && s.id == T.player ? $(T.create_roomitem(s)).prependTo(T.itemsElement) : $(T.create_roomitem(s)).appendTo(T.itemsElement),
				E.STATUS[e.id] && T.itemremove(e),
				E.AppendStatusItem(s.id, t.find(".item-status-bar"), s.status)
			}
		},
		items: function(e) {
			T.itemsElement.empty(),
			E.STATUS = {};
			for (var t = 0; t < e.items.length; t++) {
				var s, i = e.items[t];
				if (i) if (!R.off_plist || !i.p || i.id == T.player) s = R.item_firstme && i.id == T.player ? $(T.create_roomitem(i)).prependTo(T.itemsElement) : $(T.create_roomitem(i)).appendTo(T.itemsElement),
				E.AppendStatusItem(i.id, s.find(".item-status-bar"), i.status)
			}
		},
		create_roomitem: function(e) {
			var t = [];
			return t.push("<div class='room-item' itemid='" + e.id + "'>"),
			e.max_hp && (t.push('<div class="item-status"'), E.IsShow || R.show_hp || t.push(' style="display:none;"'), t.push(">"), t.push('<div class="progress hp"><div class="progress-bar" max="' + e.max_hp + '"  style="width:' + T.countwidth(e.hp, e.max_hp) + '%"></div></div>'), t.push('<div class="progress mp"><div class="progress-bar" max="' + e.max_mp + '"   style="width:' + T.countwidth(e.mp, e.max_mp) + '%"></div></div>'), t.push("</div>")),
		...
		exits: function(e) {
			...
			if (t) if (T.room_exits = t, R.exits_dir) {
				...
				for (n = 0; n < i.length; n++) 0 < n && s.push(n == i.length - 1 ? " 和 ": "、"),
		...
		item: function(e) {
			if (S(e.desc), e.commands) {
				for (var t = ["<div class='item-commands'>"], s = 0; s < e.commands.length; s++) t.push("<span cmd='" + e.commands[s].cmd + "'>"),
		...
		cmds: function(e) {
			if (e.items) {
				...
				for (var s = 0; s < e.items.length; s++) t.push("<span cmd='" + e.items[s].cmd + "'>"),
		...
		map: function(e) {
			A.SetMapBuffer(e.map, e.path),
			A.ShowMap(e.map, e.path)
		},
		dialog: function(e) {
			q.show(e.dialog, e)
		},
		...
		combat: function(e) {
			e.start && (1 != R.auto_showcombat || E.IsShow || E.Show(), 1 == R.auto_hideroom && (R.hide_roomdesc || $(".room_desc").hide())),
			e.end && 1 == R.auto_hideroom && (R.hide_roomdesc || $(".room_desc").show())
		},
		state: function(e) {
			if (e && e.state) {
				var t = ["<span class='title'>" + e.state + "</span>"];
				if (e.commands) for (var s = 0; s < e.commands.length; s++) t.push("<span class='item-command' cmd='" + e.commands[s].cmd + "'>"),
				t.push(e.commands[s].name),
				t.push("</span>");
				...
				T.states && T.states.length && ("string" == typeof T.states && (T.states = [T.states]), T.timer = setInterval(T.updatestate, e.interval || 5e3))
			} else $(".state-bar").addClass("hide").empty(),
			$(".state-tool").hide(),
		...
		msg: function(e) {
			...
			if (t) if (R.no_spmsg) S(t);
			else {
				T.ChannelElement || (T.ChannelCount = 0, T.ChannelElement = $("<div class='channel'><pre></pre></div>").insertBefore(u), T.ChannelPro = T.ChannelElement.find("pre"), T.ChannelElement.on("click", q.channel.show.bind(q.channel)), T.ChannelElement.on("mousedown", q.channel.endScroll), T.ChannelElement.on("mouseup", q.channel.beginScroll));
				var s = q.channel.isBottom();
				1 == q.channel.datas.length && T.ChannelPro.empty(),
				T.ChannelPro.append(t),
				s && q.channel.scrollBottom()
			}
		},
	...
	j = {
		...
		Close: function(e) { - 1 < this.Elemes.indexOf(e) && (e.remove(), this.Elemes.Remove(e), this.Settop())
		},
		Settop: function() {
			for (var e = 0,
			t = 0; t < j.Elemes.length; t++) {
				var s = j.Elemes[t];
				s.css("bottom", e),
				e += s.height() + 14
			}
	...
	E = {
		...
		Show: function() {
			...
			E.IsShow = !0,
			R.show_hp || $(".room-item>.item-status").show(),
			$(".combat-panel").removeClass("hide"),
			$(".right-bar")[0].style.bottom = "7em"
		},
		Hide: function() {
			E.IsShow = !1,
			R.show_hp || $(".room-item>.item-status").hide(),
		...
		create_actions: function(e) {
			if (this.Actions) for (var t = this.Actions.concat(this.RoomCommands || []), s = $(".room-commands"), i = 0; i < t.length; i++) if (!t.elem) {
				var n = t[i],
				o = [];
				o.push("<span class='act-item' cmd='" + n.cmd + "'>"),
				o.push(n.name),
				n.distime && o.push("<span class='shadow'></span>"),
				o.push("</span>"),
				n.elem || (n.elem = $(o.join("")).appendTo(s))
			}
		},
		DisObj: function(e) {
			if (this.Actions) for (var t = "use " + e.id,
			s = 0; s < this.Actions.length; s++) {
				var i = this.Actions[s];
				if (i.cmd == t) {
					if (!e.count) return this.Actions.splice(s, 1),
					i.elem.remove();
		...
		ANI_OBJ: function(e, t, s) {
			if (e) {
				...
				e.style.left = i + "%",
				setTimeout(E.ANI_OBJ, 1e3, e, t, s + 1e3)
			}
		},
		...
		On_Perform: function(e) {
			if (this.Skills) {
				...
				E.ani_time = E.ani_time || 0,
				e.rtime > E.ani_time && (E.distime = e.rtime, E.ani_time = e.rtime),
				this.time_handler || E.ANI_PFM()
			}
		},
		PFM_INTERVAL: 300,
		ANI_PFM: function() {
			for (var e = 100 * E.ani_time / E.distime,
			t = 0; t < E.Skills.length; t++) {
				for (var s = E.Skills[t], i = e, n = 0; n < E.dis_pfms.length; n++) if (E.dis_pfms[n].id == s.id && E.dis_pfms[n].distime) { (i = 100 * E.dis_pfms[n].ani_time / E.dis_pfms[n].distime) < 0 ? E.dis_pfms.splice(n, 1) : E.dis_pfms[n].ani_time -= E.PFM_INTERVAL;
					break
				}
				0 < i ? (s.shadow.style.left = 100 - i + "%", s.shadow.style.display = "block") : (s.shadow.style.display = "none", s.shadow.style.left = "0px")
			}
			0 < E.ani_time || E.dis_pfms.length ? E.time_handler = setTimeout(E.ANI_PFM, E.PFM_INTERVAL) : E.time_handler = null,
			E.ani_time -= E.PFM_INTERVAL
		},
		...
		UpdaeBar: function(e, t, s) {
			...
			if (null != i) {
				...
				e["max_" + t] ? (n = e["max_" + t], o.attr("max", n)) : n = parseInt(o.attr("max")),
				o.css("width", E.CountWidth(i, n) + "%")
			}
		},
		CountWidth: function(e, t) {
			if (0 == t) return 0;
		...
		StatusItem_add: function(e, t) {
			if (e) {
				var s = [];
				s.push('<span class="status-item'),
				t.downside && s.push(" downside"),
				s.push('" sid="'),
				s.push(t.sid),
				s.push('">'),
				s.push(t.name),
				null != t.count && (s.push("x"), s.push(t.count)),
		...
		StatusItem_refresh: function(e, t) {
			if (e) {
				...
				if (s) {
					...
					s.count = t.count,
					s.elem.innerHTML = s.name + "x" + s.count + i.outerHTML,
					s.handler && clearTimeout(s.handler),
					s.anitime = s.duration,
					E.StatusItemANI(s)
				}
			}
		},
		...
		StatusItemANI: function(e) {
			...
			e.handler = 0 < s ? setTimeout(E.StatusItemANI, 1e3, e) : 0
		}
	};
	var A = {
		...
		CreateExitsMap: function(e, t, s) {
			...
			for (var h in r.push('<svg style="margin-left:-2em" height="' + n + '" width="' + t + '">'), r.push('<rect x="' + o + '" y="' + a + '"  fill="dimgrey" stroke-width="1" stroke="gray" '), r.push('width="60" height="20"></rect>'), r.push(' <text x="' + (o + 30) + '" y="' + (a + 14) + '" fill="#232323" text-anchor="middle" style="font-size:12px;">' + s + "</text>"), e) {
				...
				var p = e[h];
				"south_2" == h ? h = "down": "north_2" == h && (h = "up"),
				r.push('<rect x="' + d[0] + '" y="' + d[1] + '" dir="' + h + '" fill="#232323" stroke-width="1" stroke="gray" '),
				r.push('width="60" height="20"></rect>'),
				r.push(' <text x="' + (d[0] + 30) + '" y="' + (d[1] + 14) + '" dir="' + h + '" fill="dimgrey" text-anchor="middle" style="font-size:12px;">' + p + "</text>"),
			...
			if (e) {
				...
				if (A.MapWidth < c && (r = (c - A.MapWidth) / 2, A.MapWidth = c), A.MapHeight = 50 * (i.maxY + o + 1), !(A.MapWidth < 0 || A.MapHeight < 0)) {
					...
					for (var m = 0; m < e.length; m++) {
						...
						s.push(' <text x="' + (d + 30) + '" y="' + (p + 14) + '" fill="#232323" text-anchor="middle" style="font-size:12px;">' + e[m].n + "</text>")
					}
					s.push("</svg>"),
					h.html(s.join("")),
					this.MapContent = $("svg"),
					this.IsShow || (this.IsShow = !0, $(".map-panel").slideDown("fast")),
		...
		ZoomIn: function(e) {
			if (!e.zoom) {
				A.ZoomState = A.ZoomState / e.zoom,
				200 < A.ZoomState && (A.ZoomState = 200),
				A.ZoomState < 80 && (A.ZoomState = 80);
				var t = A.MapWidth * A.ZoomState / 100,
				s = A.MapHeight * A.ZoomState / 100;
				this.MapContent.attr("viewBox", "0,0," + t + "," + s)
			}
		},
		SetRoom: function(e) {
			if (this.Room = e, this.IsShow) {
				this.CurRoomItem && (this.CurRoomItem.attr("fill", "dimgrey"), this.CurRoomItem.attr("stroke", "gray")),
				...
				if (t.length) {
					...
					i = document.querySelector(".map-panel"),
					n = i.offsetHeight,
					o = i.offsetWidth;
					i.scrollTop = s[1] - (n - s[3]) / 2,
					i.scrollLeft = s[0] - (o - s[2]) / 2
				}
		...
		LoadMap: function() {
			if (this.IsShow) return this.IsShow = !1,
	...
	q = {
		...
		curItem: null,
		show: function(e, t) {
			if (e) if (t) this[e].onData(t);
			else {
				if (this.isShow && e == this.curItem) return this.hide();
				this.curItem && e != this.curItem && (q[q.curItem].close && q[q.curItem].close(), q[q.curItem].isShow = !1, q.contentElement.empty()),
				this.init(),
				this.curItem = e,
				this[e].show(t)
			}
		...
		footerClick: function() {
			...
			if (!e.is(".select")) {
				var t = e.attr("for");
				e.parent().find(".select").removeClass("select"),
				e.addClass("select"),
				q[q.curItem].footerChanged(t)
			}
		},
		title: function(e) {
		...
		score: {
			...
			selectIndex: 0,
			onData: function(e) {
				if (console.log(e), this.data = e, this.init_elem(), q.titleElement.html(e.name), q.icon("user"), e.titles) this.titles = e.titles,
				this.create_titles();
				else {
			...
			footerChanged: function(e) {
				...
				1 == e ? this.uid && T.player != this.uid ? c("score2 " + this.uid) : c("score2") : 2 != e || this.titles || (c("score title"), t.on("click", ".btn-noused",
				function(e) {
					for (var t = parseInt($(e.target).attr("index")), s = 0; s < this.titles.length; s++) this.titles[s].use = s == t && !this.titles[s].use;
					c("title " + t),
					this.create_titles()
				}.bind(this)))
			},
			create_titles: function() {
				for (var e = $(".dialog-titles"), t = [], s = 0; s < this.titles.length; s++) t.push("<div class='title-item'>"),
		...
		map: {
			...
			show: function() {
				q.init(),
				q.footer(""),
				q.contentElement.append($(".map")),
				q.icon("map-marker"),
				q.iconElement.attr("class", "dialog-icon glyphicon glyphicon-map-marker")
			},
			hide: function() {
	...
	function M(e) {
		if (!e) return "";
		var t = [];
		return 1e4 <= e && (t.push(parseInt(e / 1e4) + "两<hiy>黄金</hiy>"), e %= 1e4),
		100 < e && (t.push(parseInt(e / 100) + "两<wht>白银</wht>"), e %= 100),
	...
	q.skills = {
		...
		hide: function() {
			if (this.skill_element) return this.skill_element.remove(),
			...
			if (this.skills) {
				...
				if (e.enable) {
					if (t.enable_skill) {
						...
						t.enable_skill = null,
						this.skills[s][e.id],
						this.updateSkillItem(this.skills[s])
					}
					this.skills[e.enable][e.id] = !0,
					t.enable_skill = e.enable,
					this.updateSkillItem(this.skills[e.enable]),
					this.updateSkillItem(this.skills[e.id])
				} else if (null != e.exp || null != e.level) e.level && (t.level = e.level),
				e.exp && (t.exp = e.exp),
				this.updateSkillItem(t);
				else if (0 == e.enable && t.enable_skill) {
					s = t.enable_skill;
					this.skills[s][e.id],
					t.enable_skill = null,
					this.updateSkillItem(this.skills[s]),
		...
		createSkillItem: function(e, t) {
			...
			return s.push('<span class="skill-level">'),
			s.push(e.level),
			s.push("级 / "),
			s.push(e.exp),
			s.push("%"),
			s.push("&nbsp;"),
			s.push(q.skills.get_lvdesc(e.level)),
			s.push("</span></div>"),
			s.join("")
		},
		...
		item_click: function() {
			var e = $(this),
			t = ["<div class='item-commands'>"],
			s = q.skills.skills[e.attr("skid")];
			if (s) {
				...
				t.push('<span cmd="_confirm fangqi ' + s.id + '">遗忘</span>'),
				t.push('<span cmd="lianxi ' + s.id + '">练习</span>'),
				t.push("</div>"),
				q.skills.element.find(".item-commands").remove(),
				$(t.join("")).appendTo(e)
			}
		}
	},
	q.master = {
		...
		onData: function(e) {
			...
			if (e.master || e.follower) {
				...
				e.limit && (this.is_follower ? q.footer("<span class='obj-money'>" + e.target + "目前的技能上限为<HIC>" + e.limit + "</HIC>级</span>") : q.footer("<span class='obj-money'>你目前的技能上限为<HIC>" + e.limit + "</HIC>级</span>"))
			}
		},
		show: function() {
		...
		item_click: function() {
			...
			if (t) {
				...
				s.push("</div>"),
				q.master.element.find(".item-commands").remove(),
				$(s.join("")).appendTo(e)
			}
		}
	},
	q.pack = {
		...
		updateitem: function(e) {
			if (this.items) {
				...
				var s;
				if (null != e.uneq) return (s = this.eqs[e.uneq]).can_eq = 1,
				s.count = 1,
				this.items.push(s),
				!(this.eqs[e.uneq] = null);
				if (e.jldesc) return (n = []).push(e.jldesc),
				n.push("<span class='item-commands'>"),
				n.push('<span cmd="' + this.command_before + "jinglian " + e.id + ' ok">精炼</span>'),
				n.push("</span>"),
				this.show_sub(n.join("")),
				!1;
				if (e.xqdesc) { (n = []).push(e.xqdesc),
					n.push("<span class='item-commands'>");
				...
				if (e.desc) {
					...
					n.push("<span class='item-commands'>");
					var o = e.from;
					if ("eq" == o) n.push('<span cmd="' + this.command_before + "uneq " + e.id + '">取消装备</span>');
					else if ("item" == o) {
		...
		show_sub: function(e) {
			...
			q.list.isShow && (t = q.list.rightElement),
			this.objelement = $("<pre class='obj-desc'>" + e + "</pre>").appendTo(t.parent()).on("click",
			function() {
		...
		show: function() {
			...
			this.isShow = !0,
			this.init_element(),
			this.packElement.on("click", ".obj-item", q.pack.item_click),
			this.eqElement.on("click", ".eq-item", q.pack.eqitem_click),
			this.element.appendTo(q.contentElement),
			this.items ? (c("pack none"), this.show_items()) : c("pack")
		},
		create_eqs: function() {
		...
		createItems: function() {
			if (this.items) {
				for (var e = [], t = 0; t < this.max_count; t++) {
					var s = this.items[t];
					e.push('<div class="obj-item" oindex="'),
					e.push(t),
					e.push('">'),
					s && (e.push(s.name), 1 == this.show_type ? (e.push("<span class='obj-value'>"), e.push("每"), e.push(s.unit), e.push(M(s.value)), e.push("："), e.push(s.count), e.push(s.unit), e.push("</span>")) : 1 < s.count && (e.push("<span class='obj-value'>"), e.push(s.count), e.push(s.unit), e.push("</span>"))),
					e.push("</div>")
				}
		...
		item_click: function() {
			...
			if (q.pack.element.find(".item-commands").remove(), s) {
				...
				i.push('<span cmd="checkobj ' + s.id + ' from item">查看</span>'),
				q.pack.create_item_command(s, i),
				i.push("</span>"),
				$(i.join("")).appendTo(e)
			}
		},
		eqitem_click: function() {
			...
			t = q.pack.eqs[e.attr("oindex")];
			t && c("checkobj " + t.id + " from eq")
		}
	},
	q.pack2 = {
		onData: function(e) {
			if (this.show(), e.items) this.eqs = e.eqs || [],
			this.money = e.money,
			this.id = e.id,
			...
			this.max_count = e.max_item_count;
			else if (0 == this.updateitem(e)) return;
			this.show_items(),
			this.show_moeny()
		},
		...
		show: function() {
			q.isShow || q.show("pack2"),
			this.objelement && (this.objelement.remove(), this.objelement = null, this.packElement && this.packElement.show()),
			this.isShow || (this.isShow = !0, this.init_element(), this.packElement.on("click", ".obj-item", this.item_click), this.eqElement.on("click", ".eq-item", this.eqitem_click), this.element.appendTo(q.contentElement))
		},
		item_click: function() {
			var e = $(this),
			t = e.attr("oindex"),
			...
			if (q.pack2.element.find(".item-commands").remove(), s) {
				var i = ["<span class='item-commands'>"];
				i.push('<span cmd="' + q.pack2.command_before + " checkobj " + s.id + ' from item">查看</span>'),
				q.pack2.create_item_command(s, i),
				i.push("</span>"),
				$(i.join("")).appendTo(e)
			}
		},
	...
	q.trade = {
		...
		onData: function(e) {
			this.isShow || q.show("trade"),
			q.title("和" + e.name + "交易中");
			q.pack.items;
			this.trade_target = e.target,
			this.trade_list.length = 0,
			q.pack.items ? this.update_pack() : c("pack"),
			q.pack.isShow = !1,
		...
		create_items: function(e, t, s) {
			for (var i = [], n = 0; n < s; n++) {
				...
				i.push(n),
				i.push('"'),
				o ? (i.push(" oid='" + o.id + "'>"), i.push(o.name), 1 < o.count && (i.push("<span class='obj-value'>"), i.push(o.count), i.push(o.unit), i.push("</span>"))) : i.push("'>"),
				i.push("</div>")
			}
			e.html(i.join(""))
		},
		left_click: function() {
			...
			t = q.trade.trade_list[e];
			if (t) return q.trade.cancle_trade(t),
			!1
		},
		...
		right_click: function() {
			...
			if (!e.is(".disabled")) {
				var t = e.attr("oindex"),
				s = q.pack.items[t];
				if (s) return 1 < s.count ? U.Show_trade_add(s) : q.trade.add_trade(s),
				!1
			}
		},
		add_trade: function(e) {
			for (var t = 0; t < this.trade_list.length; t++) if (e.id == this.trade_list[t].id) return this.trade_list[t].count += e.count,
			this.create_items();
	...
	q.list = {
		...
		updateitem: function(e) {
			if (e.store) {
				...
				t ? t.count -= e.store: ((t = $.extend({},
				s)).id = e.id, t.count = -e.store, q.pack.items.push(t)),
				s ? s.count += e.store: ((s = $.extend({},
				t)).id = e.storeid, s.count = e.store, this.stores.push(s)),
				0 == s.count && this.stores.Remove(s),
				0 == t.count && q.pack.items.Remove(t)
			} else if (e.sell) {
				if (t = this.find_item(2, e.id)) return t.count -= e.sell,
				this.create_items(this.selllist, this.leftElement, 2, this.selllist.length)
			}
			this.isstore && (this.create_items(this.stores, this.leftElement, 3, this.max_store_count), q.title("你的仓库中有" + this.stores.length + "/" + this.max_store_count + "件物品")),
			this.update_pack(),
		...
		onData: function(e) {
			if (this.show(), e) {
				...
				e.selllist && (this.isstore = !1, this.gongji = t, this.money_name = null, e.gongji ? this.money_name = "门派功绩": e.jungong && (this.money_name = "军功"), this.selllist = e.selllist, this.create_items(e.selllist, this.leftElement, 2, e.selllist.length), q.titleElement.html(e.title), q.icon("shopping-cart")),
				this.update_pack(),
				e.stores && (this.create_items(e.stores, this.leftElement, 3, e.max_store_count), this.isstore = !0, this.stores = e.stores, q.titleElement.html("你的仓库中有" + e.stores.length + "/" + e.max_store_count + "件物品"), this.max_store_count = e.max_store_count, q.icon("lock")),
				t && (this.gongji = t, this.show_footer(t)),
				e.seller && (this.seller = e.seller)
			}
		},
		show: function(e) {
			q.isShow && "list" == q.curItem || q.show("list"),
			this.rightElement && (this.rightElement.show(), q.pack.objelement && q.pack.objelement.remove()),
			this.isShow || (this.element || (this.element = $('<div class="dialog-list"><div class="obj-list"></div><div class="obj-list"></div></div >'), this.leftElement = $(this.element.children()[0]), this.rightElement = $(this.element.children()[1])), this.element.on("click", ".obj-item", q.list.item_click), this.element.appendTo(q.contentElement.empty()), this.isShow = !0)
		},
		...
		create_items: function(e, t, s, i) {
			for (var n = [], o = 0; o < i; o++) {
				var a = e[o];
				n.push('<div class="obj-item" '),
				a ? (n.push('obj="'), n.push(a.id), n.push('" otype="'), n.push(s), n.push('">'), n.push(a.name), n.push("<span class='obj-value'>"), 2 == s ? (n.push("每"), n.push(a.unit), n.push(this.money_name ? a.value + "<hiy>" + this.money_name + "</hiy>": M(a.value)), -1 == a.count ? n.push("：大量现货") : (n.push("：剩余"), n.push(a.count), n.push(a.unit))) : 1 != s || this.isstore ? 1 < a.count && (n.push(a.count), n.push(a.unit)) : a.value ? (n.push("每"), n.push(a.unit), n.push(M(a.value)), n.push("："), n.push(a.count), n.push(a.unit)) : n.push("不可出售"), n.push("</span>")) : n.push('">'),
				n.push("</div>")
			}
			t.html(n.join(""))
		},
		item_click: function() {
			...
			t = e.attr("obj"),
			s = e.attr("otype"),
			i = q.list.find_item(s, t);
			if (i) {
				var n = ["<div class='item-commands'>"];
				q.list.isstore ? 3 == s ? (n.push('<span cmd="checkobj ' + t + ' from store">查看</span>'), n.push('<span cmd="_confirm qu ' + t + '">取出</span>')) : 1 == s && (n.push('<span cmd="checkobj ' + t + ' from item">查看</span>'), n.push('<span cmd="_confirm store ' + i.count + " " + t + '">存到仓库</span>')) : 2 == s ? (n.push('<span cmd="checkobj ' + t + " from " + q.list.seller + '">查看</span>'), i.count && n.push('<span cmd="_confirm buy ' + i.count + " " + t + " from " + q.list.seller + '">购买</span>')) : 1 == s && (n.push('<span cmd="checkobj ' + t + ' from item">查看</span>'), n.push('<span cmd="_confirm sell ' + i.count + " " + t + " to " + q.list.seller + '">卖掉</span>')),
				n.push("</div>"),
				q.list.element.find(".item-commands").remove(),
				$(n.join("")).appendTo(e)
			}
		}
	},
	q.channel = {
		...
		last_click: 0,
		show: function() {
			if (500 < Date.now() - this.last_click) this.last_click = Date.now();
			else if (!q.channel.isShow) {
				q.select("channel"),
				q.icon("comment"),
				q.title(""),
				q.footer("");
				...
				q.contentElement.html("").append(T.ChannelElement.addClass("channel-dialog")),
				q.channel.isShow = !0,
				q.channel.scrollBottom()
			}
		},
		hide: function() {
			q.channel.footerChanged(""),
			T.ChannelElement.removeClass("channel-dialog").insertBefore(u),
			this.scrollBottom(),
			this.isShow = !1
		},
		close: function() {
		...
		createElement: function(e, t) {
			...
			n.push(i),
			n.push("】"),
			e.name && (n.push("<span"), e.uid && n.push(" cmd='look3 " + e.uid + "'"), n.push(">"), n.push(e.name), n.push("</span>：")),
			n.push(e.content),
			t && n.push("\n");
			var o = n.join("");
			return 500 < this.datas.length && (this.datas.length = 0),
			"rumor" == e.ch && (e.ch = "sys"),
			this.datas.push([e.ch, o]),
			this.select_item && this.select_item != e.ch ? "": o
		}
	},
	q.setting = {
		...
		footerChanged: function(e) {
			...
			"setting" == e ? (this.selectitem.on("click", ".switch", this.switchClick), this.selectitem.on("click", ".color-item", this.colorClick)) : "custom" == e ? (this.selectitem.on("click", ".switch", this.switchClick), this.selectitem.on("click", ".setting-ok", this.save_custom)) : this.selectitem.on("click", ".help-item", this.helpClick),
			this.selectitem.appendTo(q.contentElement)
		},
		helpClick: function() {
		...
		hide: function() {
			if (this.frame) return this.close_help(),
			!1;
			this.close()
		},
		close: function() {
		...
		get_pfms: function(e) {
			...
			for (var t = [], s = 0; s < E.Skills.length; s++) 0 < t.length && t.push(","),
			t.push(E.Skills[s].id);
			$("#" + e).val(t.join("")),
			S("<hic>已自动设置为你默认的绝招，你可以修改为适合你的出招顺序后点击保存。</hic>")
		},
	...
	q.tasks = {
		...
		show: function() {
			...
			c("tasks"),
			this.isShow || (this.element.appendTo(q.contentElement), q.footer(""), this.isShow = !0)
		},
		create_items: function() {
			for (var e = [], t = 0; t < this.items.length; t++) {
				...
				e.push("</pre>"),
				e.push("<span"),
				1 == s.state ? (e.push(" class='task-btn start'>"), e.push("进行中")) : 2 == s.state ? (e.push(' cmd="taskover '), e.push(s.id), e.push('"'), e.push(" class='task-btn finish'>"), e.push("可领取")) : 3 == s.state && (e.push(" class='task-btn over'>"), e.push("已完成")),
				e.push("</span>"),
				e.push("</div>")
			}
	...
	q.stats = {
		...
		create_scores: function(e, t) {
			for (var s = [], i = ["一　", "二　", "三　", "四　", "五　", "六　", "七　", "八　", "九　", "十　", "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十"], n = 0; n < i.length; n++) s.push("<div class='top-item scores top"),
			s.push(n + 1),
			s.push("' top='"),
			s.push(n + 1),
		...
		create_tops: function(e, t) {
			for (var s = [], i = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十"], n = 0; n < i.length; n++) s.push("<div class='top-item top top"),
			s.push(n + 1),
			s.push("' top='"),
			s.push(n + 1),
			s.push("'><span class='top-title'>"),
		...
		create_weapons: function(e) {
			for (var t = [], s = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十"], i = 0; i < s.length; i++) t.push("<div class='top-item weapon top"),
			t.push(i + 1),
			t.push("' top='"),
			t.push(i + 1),
		...
		show: function() {
			...
			c("stats " + this.selectedItem.cmd),
			this.element || (this.element = $("<div class='dialog-stats'></div>")),
			this.isShow || (this.create_footer(), q.icon("stats"), q.contentElement.html(this.element), this.element.on("click", ".top-item", this.itemClick), this.isShow = !0)
		},
		create_footer: function() {
	...
	q.jh = {
		...
		onData: function(e) {
			...
			if (e.unlock) return this.unlock = e.unlock || 0,
			this.unlock >= this.fbs.length && (this.unlock = this.fbs.length - 1),
			void this.update_lock();
		...
		select: function(e) {
			...
			if (t.length && !t.is(".selected")) {
				var s = t[0].offsetTop,
				i = this.listElement.height();
				i / 2 < s && (s = (i - t.height()) / 2, q.jh.listElement[0].scrollTop = s),
				q.jh.selectedItem && q.jh.selectedItem.removeClass("selected"),
				q.jh.selectedItem = t,
				q.jh.selectedItem.addClass("selected")
			}
		},
		show_fbdesc: function(e) {
			if (e) {
				...
				t.push(e.desc),
				this.unlock >= e.index ? (t.push('<span class="item-commands">'), e.no_single || t.push('<span cmd="jh fb ' + e.index + ' start1">进入副本</span>'), e.is_diffi && t.push('<span cmd="jh fb ' + e.index + ' start2">困难模式</span>'), e.is_multi && t.push('<span cmd="jh fb ' + e.index + ' start3">组队进入</span>'), t.push("</span>")) : t.push(""),
				t.push(e.reward),
				t.push("</pre>"),
				this.descElement.html(t.join("\n")),
				this.select(e.index)
	...
	q.shop = {
		...
		onData: function(e) {
			...
			e.selllist && (this.selllist = e.selllist, this.show_items()),
			this.show_moeny()
		},
		show_items: function() {
		...
		show: function(e) {
			...
			this.isShow || (q.title("商品列表"), q.icon("shopping-cart"), this.isShow = !0, this.element.appendTo(q.contentElement), this.selllist ? this.show_moeny() : c("shop"))
		},
	...
	q.message = {
		...
		hide: function() {
			if (this.element.is(".detail")) return this.element.removeClass("detail"),
			this.detailID = null,
			!1
		},
		selected_item: 0,
		...
		onData: function(e) {
			...
			e.message && (this.isShow || this.unRead++, this.messages && this.addMessage(e.message), "notice" == e.message.id && this.showNotice(e.message)),
		...
		show: function(e) {
			this.unRead = 0,
			this.showUnread(),
			this.isShow || (this.isShow = !0, q.title("消息"), q.icon("envelope"), this.create_footer(), this.footerChanged(this.selected_item), this.isLoad || c("message"), this.isLoad = !0, this.element.on("click", ".message-item", this.showMessageDetail))
		},
		footers: ["消息", "队伍", "关系", "帮派"],
		...
		showChild: function() {
			...
			q.contentElement.html(e.element),
			this.selectedChild != e && (this.selectedChild && this.selectedChild.close(), e.show(), this.selectedChild = e)
		},
		...
		createMessageDetailItem: function(e, t, s) {
			...
			if (i.push("<div class='detail-item' index='" + s.index + "'>"), i.push("<span class='detail-name'>"), i.push(t), i.push("</span>"), i.push("<span class='detail-time'>"), i.push(this.getTimedesc(s.time)), i.push("</span>"), i.push("<pre class='detail-content'>"), i.push(s.content), i.push("</pre>"), s.attach) {
				for (var n = 0; n < s.attach.length; n++) i.push("<div class='detail-attach'>"),
	...
	q.relation = {
		...
		onData: function(e) {
			...
			e.husband ? (t.push("你的丈夫："), t.push(e.husband)) : e.wife ? (t.push("你的妻子："), t.push(e.wife)) : t.push("你目前没有结婚。"),
			t.push("</div>"),
			e.wife && (t.push("<div class='item-commands'>"), t.push("<span cmd='_confirm greet wife'>❀送花❀</span>"), t.push("</div>")),
			t.push("<div class='relation-item'>"),
			e.shifu ? (t.push("你的师父："), t.push(e.shifu)) : e.tudi ? (t.push("你的徒弟："), t.push(e.tudi)) : t.push("你目前没有拜师，也没有收徒。"),
			e.shifu && (t.push("<div class='item-commands'>"), t.push("<span cmd='greet master'>请安</span>"), e.sid && t.push("<span cmd='team add " + e.sid + "'>邀请组队</span>"), t.push("</div>")),
			e.tid && (t.push("<div class='item-commands'>"), t.push("<span cmd='team add " + e.tid + "'>邀请组队</span>"), t.push("</div>")),
			null != e.st && (t.push("<div class='relation-item'>"), t.push("你本周已完成" + e.st + "次师徒任务。"), t.push("</div>")),
			e.reward && (t.push("<div class='relation-item'>"), t.push(e.reward), t.push("</div>")),
			t.push("</div>"),
			this.element.html(t.join(""))
		},
		close: function() {
	...
	q.party = {
		...
		level_roles: [1, 20, 30, 40, 50],
		level: 5,
		get_role: function(e) {
			if (this.roles) for (var t = 0; t < this.roles.length; t++) if (this.roles[t].id == e) return this.roles[t]
		},
		onData: function(e) {
			if (e.name) {
				var t = e,
				...
				s.push("</div>"),
				t.notice && (s.push("<div class='party-notice'><hio><span class='glyphicon glyphicon-volume-up'></span>"), s.push(t.notice), s.push("</hio></div>")),
				s.push("<div class='party-roles'>");
				for (var i = 0; i < t.roles.length; i++) {
					var n = t.roles[i];
					n.id == T.player && (this.level = n.level),
				...
				this.roles = e.roles,
				this.element.html(s.join(""))
			} else this.element.html("<wht>你没有加入帮派<wht>")
		},
		show_commands: function() {
			var e = q.party.get_role($(this).attr("roleid"));
			if (e) {
				var t = ["<div class='item-commands'>"];
				e.id == T.player ? t.push('<span cmd="party out">退出帮派</span>') : (e.level > q.party.level - 1 && 2 < e.level && t.push('<span cmd="party uplevel ' + e.id + '">提升为' + q.party.levels[e.level - 1] + "</span>"), e.level > q.party.level && e.level < 5 && t.push('<span cmd="party downlevel ' + e.id + '">降级为' + q.party.levels[e.level + 1] + "</span>"), 1 == q.party.level && 2 == e.level && t.push('<span cmd="party trans ' + e.id + '">让位</span>'), e.level > q.party.level && t.push('<span cmd="party remove ' + e.id + '">开除</span>'), e.online && t.push('<span cmd="team add ' + e.id + '">邀请组队</span>')),
				1 != t.length && (t.push("</div>"), q.party.element.find(".item-commands").remove(), $(t.join("")).appendTo(this))
			}
		},
		close: function() {
			this.element.remove(),
	...
	q.team = {
		...
		clickItem: function() {
			var e = $(this),
			t = q.team.items[e.attr("index")];
			if (t) {
				var s = ["<div class='item-commands'>"];
				s.push('<span cmd="look3 ' + t.id + '">查看</span>');
				var i = q.team.items[0].id == T.player;
				i && t.id != T.player ? s.push('<span cmd="team remove ' + t.id + '">移出队伍</span>') : t.id == T.player && s.push('<span cmd="team out ' + t.id + '">退出队伍</span>'),
				i && t.id == T.player && s.push('<span cmd="team set">更改分配方式</span>'),
				s.push("</div>"),
				q.team.element.find(".item-commands").remove(),
				$(s.join("")).appendTo(e)
			}
		}
	},
	...
	var R = {
		...
		launchFullScreen: function(e) { (e = e || document.documentElement).requestFullscreen ? e.requestFullscreen() : e.mozRequestFullScreen ? e.mozRequestFullScreen() : e.webkitRequestFullscreen ? e.webkitRequestFullscreen() : e.msRequestFullscreen && e.msRequestFullscreen()
		},
	...
	var U = {
		...
		Show: function(e) {
			...
			this.Parameter.footer ? (this.btn.show(), this.btn.find(".btn-text").html(this.Parameter.btn_text), this.content.css("width", "65%")) : (this.btn.hide(), this.content.css("width", "100%")),
			this.isShow = !0
		},
		Close: function() {
		...
		Init: function() {
			this._init || (this.element = $(".dialog-confirm"), this.content = this.element.find(".dialog-content"), this.btn = this.element.find(".dialog-btn"), this.element.on("click", ".btn-ok",
			function(e) {
				return U.Parameter.onOK(),
				U.Close(),
				!1
			}), this.element.on("click", ".btn",
			function(e) {
				var t = U.max_count || 1e3,
				s = $(e.target),
				i = parseInt(s.attr("ac")),
				n = s.parent().find("input"),
				o = parseInt(n.val());
				return "NaN" == o.toString() && (o = 0),
				-10 == i ? o -= 10 : 10 == i ? (1 == o && (o = 0), o += 10) : o = 1 == i ? t: 1,
				o < 1 ? o = 1 : t < o && (o = t),
				n.val(o),
				!1
			}), this._init = !0)
		...
		Show_shop: function(e) {
			...
			if (s) {
				...
				t && this.Show({
					...
					btn_text: "购买" + t.name,
					onOK: function() {
						var e = U.count_element.find("input"),
						t = parseInt(e.val());
						"NaN" == t.toString() && (t = 0),
						t && (t > U.max_count && (t = U.max_count), c("shop " + s + " " + t))
					}
				})
			}
		},
		Show_buy: function(s) {
			...
			if (i) {
				var e = parseInt(s[2]);
				this.Show({
					content: this.get_countelement(1, -1 == e ? 1e3: e),
					btn_text: "购买",
					onOK: function() {
						var e = U.count_element.find("input"),
						t = parseInt(e.val());
						"NaN" == t.toString() && (t = 0),
						t && (t > U.max_count && (t = U.max_count), c("buy " + t + " " + i + " from " + s[5]))
					}
				})
			}
		},
		Show_greet: function(e) {
			this.Show({
				...
				onOK: function() {
					...
					t = parseInt(e.val());
					"NaN" == t.toString() && (t = 0),
					t && (t > U.max_count && (t = U.max_count), c("greet " + t))
				}
			})
		},
		Show_sell: function(s) {
			var i = s[3];
			i && this.Show({
				content: this.get_countelement(s[2], s[2]),
				btn_text: "卖出",
				onOK: function() {
					var e = U.count_element.find("input"),
					t = parseInt(e.val());
					"NaN" == t.toString() && (t = 0),
					t && (t > U.max_count && (t = U.max_count), c("sell " + t + " " + i + " to " + s[5]))
				}
			})
		},
		Show_store: function(e) {
			...
			if (s) return 1 == e[2] ? c("store " + s) : void this.Show({
				...
				onOK: function() {
					...
					t = parseInt(e.val());
					"NaN" == t.toString() && (t = 0),
					t && (t > U.max_count && (t = U.max_count), c("store " + t + " " + s))
				}
			})
		},
			...
			if (s) {
				...
				if (t) return 1 == t.count ? c("qu 1 " + s) : void this.Show({
					...
					onOK: function() {
						...
						t = parseInt(e.val());
						"NaN" == t.toString() && (t = 0),
						t && (t > U.max_count && (t = U.max_count), c("qu " + t + " " + s))
					}
				})
			}
		},
		...
		Show_trade_add: function(i) {
			i && this.Show({
				content: this.get_countelement(i.count, i.count),
				btn_text: "确定",
				onOK: function() {
					var e = U.count_element.find("input"),
					t = parseInt(e.val());
			...
			if (i) {
				...
				if (t) {
					...
					if (n) {
						...
						this.Show({
							content: this.get_countelement(o),
							btn_text: "合成",
							onOK: function() {
								var e = U.count_element.find("input"),
								t = parseInt(e.val());
								"NaN" == t.toString() && (t = 0),
								t && (t > U.max_count && (t = U.max_count), c(s + "combine " + i + " " + t))
							}
						})
					}
				}
	...
	N = {
		...
		to_c: function(e) {
			...
			i = 0; e;) {
				var n = e % 10;
				s && (s % 4 == 0 && 3 != i ? (t = N.C_STR3[s / 4] + t, i = 3) : n && 2 != i && (t = N.C_STR2[s % 4] + t, i = 2)),
				n ? ((1 != n || 10 < e || s % 4 != 1) && (t = N.C_STR[n] + t), i = 1) : 1 == i && (t = N.C_STR[n] + t, i = 0),
				e = parseInt(e / 10),
				s++
			}
			return t
	...
	Array.prototype.Remove = function(e) {
		...
		s = 0; s < t; s++) if (this[s] == e) return this.splice(s, 1),
		this;
		return this
	},
	Array.prototype.Has = function(e) {
		for (var t = this.length,
		s = 0; s < t; s++) if (this[s] == e) return ! 0;
		return ! 1
	},
	...
	L.prototype.Connect = function(e) {
		try {
			location.protocol;
			this.ws = new B("ws://" + this.IP + ":" + this.Port),
	...
	G.UserAPI = {
		...
		ChangePassword: function(e, t, s) {
			return N.Post("UserAPI/ChangePassword", {
				oldpwd: e,
				pwd: t
			},
			s)
